...
INSERT INTO Equipo (id_equipo, nombre, estadio) VALUES
...
(6, 'Athletic Club', 'San Mamés'),
(7, 'Valencia CF', 'Mestalla'),
(8, 'Villarreal CF', 'La Cerámica'),
(9, 'Real Betis', 'Benito Villamarín'),
(10, 'Getafe CF', 'Coliseum Alfonso Pérez'),
(11, 'RC Celta de Vigo', 'Abanca-Balaídos'),
(12, 'CA Osasuna', 'El Sadar'),
(13, 'RCD Mallorca', 'Son Moix'),
(14, 'UD Las Palmas', 'Gran Canaria'),
(15, 'Deportivo Alavés', 'Mendizorroza'),
(16, 'Girona FC', 'Montilivi'),
(17, 'Rayo Vallecano', 'Estadio de Vallecas'),
(18, 'Real Valladolid', 'José Zorrilla'),
(19, 'RCD Espanyol', 'Stage Front Stadium'),
(20, 'CD Leganés', 'Butarque');
